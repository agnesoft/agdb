<p align="center">
    <img width="300" src="./docs/logo.svg" alt="agdb logo">
</p>
<h1 align="center">
    agdb
</h1>
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;Agnesoft Graph Database
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;Key Features
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;At a glance [Db]
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;Crate Features
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;Decision Tree
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;Roadmap
...
## <img width="25" src="./docs/logo.svg" alt="agdb logo">&nbsp;&nbsp;Reference
