...
/**
 * RemoveValuesQuery Class Doc Comment
 *
 * @category Class
 * @description Query to remove properties from existing elements in the database. All of the specified &#x60;ids&#x60; must exist in the database however they do not need to have all the listed keys (it is NOT an error if any or all keys do not exist on any of the elements).
 * @package  Agnesoft\AgdbApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RemoveValuesQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveValuesQuery';
