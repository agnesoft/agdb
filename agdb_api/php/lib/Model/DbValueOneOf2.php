...
/**
 * DbValueOneOf2 Class Doc Comment
 *
 * @category Class
 ...
 */
class DbValueOneOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DbValue_oneOf_2';
    ...
    */
    ...
    public function setU64($u64)
    {
        ...
        if (($u64 < 0)) {
            throw new \InvalidArgumentException('invalid value for $u64 when calling DbValueOneOf2., must be bigger than or equal to 0.');
        }
