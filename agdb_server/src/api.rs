...
#[openapi(
    ...
    paths(
        ...
        routes::admin::user::logout_session,
        ...
        routes::user::login,
        routes::user::logout,
        routes::user::logout_session,
        routes::user::logout_all,
        ...
        routes::cluster::user_logout_session,
        routes::cluster::user_logout_all,
        routes::cluster::status,
        routes::cluster::admin_logout,
        routes::cluster::admin_logout_session,
