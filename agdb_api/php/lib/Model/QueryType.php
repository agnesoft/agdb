...
class QueryType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets insert_index
     *
     * @param \Agnesoft\AgdbApi\Model\DbValue $insert_index Query to create a new index on a given key.
     *
     * @return self
     */
     ...
     * Sets remove_index
     *
     * @param \Agnesoft\AgdbApi\Model\DbValue $remove_index Query to create a new index on a given key.
     *
     * @return self
     */
     ...
     * Sets remove_values
     *
     * @param \Agnesoft\AgdbApi\Model\SelectValuesQuery $remove_values Query to remove properties from existing elements in the database. All of the specified `ids` must exist in the database however they do not need to have all the listed keys (it is NOT an error if any or all keys do not exist on any of the elements).
     *
     * @return self
     */
     ...
     * Sets select_aliases
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $select_aliases Query to select aliases of given ids. All of the ids must exist in the database and have an alias.  The result will be number of returned aliases and list of elements with a single property `String(\"alias\")` holding the value `String`.
     *
     * @return self
     */
     ...
     * Sets select_keys
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $select_keys Query to select only property keys of given ids. All of the ids must exist in the database.  The result will be number of elements returned and the list of elements with all properties except all values will be empty.
     *
     * @return self
     */
     ...
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $select_key_count Query to select number of properties (key count) of given ids. All of the ids must exist in the database.  The result will be number of elements returned and the list of elements with a single property `String(\"key_count\")` with a value `u64`.
     *
     * @return self
     */
