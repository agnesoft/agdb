...
/**
 * CountComparisonOneOf4 Class Doc Comment
 *
 * @category Class
 ...
 */
class CountComparisonOneOf4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountComparison_oneOf_4';
    ...
    */
    ...
    public function setLessThanOrEqual($less_than_or_equal)
    {
        ...
        if (($less_than_or_equal < 0)) {
            throw new \InvalidArgumentException('invalid value for $less_than_or_equal when calling CountComparisonOneOf4., must be bigger than or equal to 0.');
        }
