 ...
 *
 * @category Class
 * @description List of lists of properties (key-value pairs) to be applied to all elements in a query. There must be as many lists of properties as ids in a query.
 * @package  Agnesoft\AgdbApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class QueryValuesOneOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryValues_oneOf_1';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['multi'] === null) {
            $invalidProperties[] = "'multi' can't be null";
        }
