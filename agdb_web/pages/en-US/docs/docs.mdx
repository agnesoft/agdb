...
- [server client - rurst](https://github.com/agnesoft/agdb/tree/main/examples/server_client_rust)

- [server client - typescript](https://github.com/agnesoft/agdb/tree/main/examples/server_client_typescript)

- [strong types](https://github.com/agnesoft/agdb/tree/main/examples/strong_types)
