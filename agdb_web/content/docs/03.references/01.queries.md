...
<table><tr><th><b>Struct</b></th><th><b>Result</b></th></tr>
<tr><td>
...
- Beyond (controls traversal only: continues the search only beyond this element if the condition passes, does not affect element selection)
- Not (reverses the condition selection result)
- NotBeyond (controls traversal only: stops the search beyond this element if the condition passes, does not affect element selection)
