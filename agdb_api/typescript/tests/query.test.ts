...
describe("query tests", () => {
    ...
    it(`QueryBuilder::search().to(1).order_by(vec![DbKeyOrder::Asc("k".into())]).where_().node().query()`, () => {
        let query = `QueryBuilder::search().to(1).order_by(vec![DbKeyOrder::Asc("k".into())]).where_().node().query()`;
    ...
    it(`QueryBuilder::search().to(1).where_().node().query()`, () => {
        let query = `QueryBuilder::search().to(1).where_().node().query()`;
        let builder = QueryBuilder.search().to(1).where().node().query();
        expect(builder).toEqual(test_queries[query]);
    });
    ...
    it(`QueryBuilder::insert().nodes().ids(vec![1,2]).values(vec![vec![("k","v").into()],vec![(1,10).into()]]).query()`, () => {
        let query = `QueryBuilder::insert().nodes().ids(vec![1,2]).values(vec![vec![("k","v").into()],vec![(1,10).into()]]).query()`;
        let builder = QueryBuilder.insert()
            .nodes()
            .ids([1, 2])
            .values([[["k", "v"]], [[1, 10]]])
    ...
    it(`QueryBuilder::search().from(1).order_by(vec![DbKeyOrder::Asc("k".into())]).where_().node().query()`, () => {
        let query = `QueryBuilder::search().from(1).order_by(vec![DbKeyOrder::Asc("k".into())]).where_().node().query()`;
        let builder = QueryBuilder.search()
            .from(1)
            .order_by([DbKeyOrder.Asc("k")])
            .where()
    ...
    it(`QueryBuilder::search().to(1).offset(1).query()`, () => {
        ...
        let builder = QueryBuilder.search().to(1).offset(1).query();
        expect(builder).toEqual(test_queries[query]);
    });

    it(`QueryBuilder::search().from(1).limit(1).where_().node().query()`, () => {
        let query = `QueryBuilder::search().from(1).limit(1).where_().node().query()`;
        let builder = QueryBuilder.search()
            .from(1)
            .limit(1)
            .where()
    ...
    it(`QueryBuilder::search().to(1).limit(1).query()`, () => {
        ...
        let builder = QueryBuilder.search().to(1).limit(1).query();
        expect(builder).toEqual(test_queries[query]);
    });
    ...
    it(`QueryBuilder::insert().edges().from(vec![1,2]).to(vec![2,3]).each().values(vec![vec![("k",1).into()],vec![("k",2).into()]]).query()`, () => {
        let query = `QueryBuilder::insert().edges().from(vec![1,2]).to(vec![2,3]).each().values(vec![vec![("k",1).into()],vec![("k",2).into()]]).query()`;
        let builder = QueryBuilder.insert()
            .edges()
            .from([1, 2])
            .to([2, 3])
    ...
    it(`QueryBuilder::insert().edges().from(vec![1,2]).to(vec![2,3]).each().values_uniform(vec![("k",1).into(),("k",2).into()]).query()`, () => {
        let query = `QueryBuilder::insert().edges().from(vec![1,2]).to(vec![2,3]).each().values_uniform(vec![("k",1).into(),("k",2).into()]).query()`;
        let builder = QueryBuilder.insert()
            .edges()
            .from([1, 2])
            .to([2, 3])
    ...
    it(`QueryBuilder::search().from(1).offset(1).where_().node().query()`, () => {
        let query = `QueryBuilder::search().from(1).offset(1).where_().node().query()`;
        let builder = QueryBuilder.search()
            .from(1)
            .offset(1)
            .where()
    ...
    it(`QueryBuilder::insert().nodes().ids(vec![1,2]).values_uniform(vec![("k","v").into(),(1,10).into()]).query()`, () => {
        let query = `QueryBuilder::insert().nodes().ids(vec![1,2]).values_uniform(vec![("k","v").into(),(1,10).into()]).query()`;
        let builder = QueryBuilder.insert()
            .nodes()
            .ids([1, 2])
            .values_uniform([
    ...
    it(`QueryBuilder::search().depth_first().to(1).query()`, () => {
        ...
        let builder = QueryBuilder.search().depth_first().to(1).query();
        expect(builder).toEqual(test_queries[query]);
    });
