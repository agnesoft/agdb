...
/**
 * InsertIndexQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class InsertIndexQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertIndexQuery';
    ...
    */
    ...
    public function setU64($u64)
    {
        ...
        if (($u64 < 0)) {
            throw new \InvalidArgumentException('invalid value for $u64 when calling InsertIndexQuery., must be bigger than or equal to 0.');
        }
     ...
     * Sets f64
     *
     * @param float $f64 64-bit floating point number
     *
     * @return self
     */
