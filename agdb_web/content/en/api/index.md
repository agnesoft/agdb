...
<p>
    <a href="/api/rust"><img width="50" src="images/rust.png" alt="rust"></a>
    <a href="/api/typescript"><img width="50" src="images/ts.png" alt="ts"></a>
    <a href="/api/typescript"><img width="50" src="images/js.png" alt="js"></a>
    <a href="/api/python"><img width="50" src="images/python.png" alt="python"></a>
    ...
    "components": {
        "schemas": {
            ...
            "SearchQueryAlgorithm": {
                ...
                "enum": ["BreadthFirst", "DepthFirst", "Index"]
            },
            "SelectAliasesQuery": {
                "$ref": "#/components/schemas/QueryIds"
            },
