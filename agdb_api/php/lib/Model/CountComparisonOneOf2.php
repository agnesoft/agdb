...
/**
 * CountComparisonOneOf2 Class Doc Comment
 *
 * @category Class
 ...
 */
class CountComparisonOneOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountComparison_oneOf_2';
    ...
    */
    ...
    public function setGreaterThanOrEqual($greater_than_or_equal)
    {
        ...
        if (($greater_than_or_equal < 0)) {
            throw new \InvalidArgumentException('invalid value for $greater_than_or_equal when calling CountComparisonOneOf2., must be bigger than or equal to 0.');
        }
