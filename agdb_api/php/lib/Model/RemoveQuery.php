...
/**
 * RemoveQuery Class Doc Comment
 *
 * @category Class
 * @description Query to remove database elements (nodes &amp; edges). It is not an error if any of the &#x60;ids&#x60; do not already exist.  All properties associated with a given element are also removed.  If removing nodes all of its incoming and outgoing edges are also removed along with their properties.
 * @package  Agnesoft\AgdbApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RemoveQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveQuery';
