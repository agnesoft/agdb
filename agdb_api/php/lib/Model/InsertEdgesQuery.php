...
class InsertEdgesQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets from
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $from Origins
     *
     * @return self
     */
     ...
     * Sets ids
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $ids Optional ids of edges (optionally a search sub-query). This can be empty.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $to Destinations
     *
     * @return self
     */
     ...
     * Sets values
     *
     * @param \Agnesoft\AgdbApi\Model\QueryValues $values Key value pairs to be associated with the new edges.
     *
     * @return self
     */
