 ...
 */
class InsertValuesQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertValuesQuery';
    ...
    */
     ...
     * Sets ids
     *
     * @param \Agnesoft\AgdbApi\Model\QueryIds $ids Ids whose properties should be updated
     *
     * @return self
     */
     ...
     * Sets values
     *
     * @param \Agnesoft\AgdbApi\Model\QueryValues $values Key value pairs to be inserted to the existing elements.
     *
     * @return self
     */
