...
fn amend_or_i64() {
    ...
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("flags", 0b1010_i64).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_or([[("flags", 0b0110_i64).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("flags", 0b1110_i64).into()],
        }],
    );
}
...
fn amend_and_i64() {
    ...
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("flags", 0b1111_i64).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_and([[("flags", 0b1010_i64).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("flags", 0b1010_i64).into()],
        }],
    );
}
...
fn amend_xor_i64() {
    ...
    db.exec_mut(
        QueryBuilder::insert()
            .amend_xor([[("flags", 0b0110_i64).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("flags", 0b1100_i64).into()],
        }],
    );
}

#[test]
fn amend_or_missing_key_inserts() {
    let mut db = TestDb::new();
    db.exec_mut_ids(QueryBuilder::insert().nodes().count(1).query(), &[1]);
    db.exec_mut(
        QueryBuilder::insert()
...
#[test]
fn amend_or_non_integer_falls_back_to_add() {
    let mut db = TestDb::new();
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
...
#[test]
fn amend_or_i64_with_u64() {
    let mut db = TestDb::new();
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("flags", 0b1000_i64).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_or([[("flags", 0b0011_u64).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("flags", 0b1011_i64).into()],
        }],
    );
}

#[test]
fn amend_or_u64_with_i64() {
    let mut db = TestDb::new();
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("flags", 0b1000_u64).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_or([[("flags", 0b0011_i64).into()]])
            .ids(1)
            .query(),
        1,
    );
...
fn amend_or_bytes() {
    ...
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("mask", vec![0xF0_u8, 0x00]).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_or([[("mask", vec![0x0F_u8, 0xFF]).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("mask", vec![0xFF_u8, 0xFF]).into()],
        }],
    );
}
...
fn amend_and_bytes() {
    ...
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("mask", vec![0xFF_u8, 0xAB]).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_and([[("mask", vec![0x0F_u8, 0xF0]).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("mask", vec![0x0F_u8, 0xA0]).into()],
        }],
    );
}
...
fn amend_xor_bytes() {
    ...
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("mask", vec![0xFF_u8, 0x00]).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_xor([[("mask", vec![0xAA_u8, 0x55]).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("mask", vec![0x55_u8, 0x55]).into()],
        }],
    );
}

#[test]
fn amend_or_bytes_different_lengths() {
    let mut db = TestDb::new();
    db.exec_mut(
        QueryBuilder::insert()
            .nodes()
            .values([[("mask", vec![0xF0_u8, 0x0F, 0xAA]).into()]])
            .query(),
        1,
    );
    db.exec_mut(
        QueryBuilder::insert()
            .amend_or([[("mask", vec![0x0F_u8]).into()]])
            .ids(1)
            .query(),
        1,
    );
    db.exec_elements(
        ...
        &[DbElement {
            ...
            from: DbId::default(),
            to: DbId::default(),
            values: vec![("mask", vec![0xFF_u8, 0x0F, 0xAA]).into()],
        }],
    );
}
