 ...
 *
 * @category Class
 * @description Distance from the search origin. Takes count comparison (e.g. Equal, GreaterThan).
 * @package  Agnesoft\AgdbApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class QueryConditionDataOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryConditionData_oneOf';
