 ...
 */
class DbKeyOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DbKeyOrder';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['asc'] === null) {
            $invalidProperties[] = "'asc' can't be null";
        }
     ...
     * Sets asc
     *
     * @param \Agnesoft\AgdbApi\Model\DbValue $asc Ascending order (from smallest)
     *
     * @return self
     */
     ...
     * Sets desc
     *
     * @param \Agnesoft\AgdbApi\Model\DbValue $desc Descending order (from largest)
     *
     * @return self
     */
