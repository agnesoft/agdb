 ...
 */
class RemoveIndexQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RemoveIndexQuery';
    ...
    */
    ...
    public function setU64($u64)
    {
        ...
        if (($u64 < 0)) {
            throw new \InvalidArgumentException('invalid value for $u64 when calling RemoveIndexQuery., must be bigger than or equal to 0.');
        }
