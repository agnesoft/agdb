...
class QueryCondition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets data
     *
     * @param \Agnesoft\AgdbApi\Model\QueryConditionData $data Condition data (or type) defining what type of validation is to be performed.
     *
     * @return self
     */
     ...
     * Sets logic
     *
     * @param \Agnesoft\AgdbApi\Model\QueryConditionLogic $logic Logic operator (e.g. And, Or)
     *
     * @return self
     */
     ...
     * Sets modifier
     *
     * @param \Agnesoft\AgdbApi\Model\QueryConditionModifier $modifier Condition modifier (e.g. None, Beyond, Not, NotBeyond)
     *
     * @return self
     */
